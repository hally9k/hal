export const HAL__HEADER__GREEN_JOB_TITLE_ENTERS = 'HAL__HEADER__GREEN_JOB_TITLE_ENTERS';
export const HAL__HEADER__GREEN_JOB_TITLE_LEAVES = 'HAL__HEADER__GREEN_JOB_TITLE_LEAVES';
export const HAL__HEADER__BLUE_JOB_TITLE_ENTERS = 'HAL__HEADER__BLUE_JOB_TITLE_ENTERS';
export const HAL__HEADER__BLUE_JOB_TITLE_LEAVES = 'HAL__HEADER__BLUE_JOB_TITLE_LEAVES';
